...
public class BostaController : ControllerBase
{
    ...
    private readonly BostaClient _bostaClient;
    private readonly AuditLogService _auditLog;
    private readonly IBackgroundJobClient _jobs;

    public BostaController(AppDbContext db, BostaClient bostaClient, AuditLogService auditLog, IBackgroundJobClient jobs)
    {
        _db = db;
